...
[![Cookbook](http://img.shields.io/badge/cookbook-v0.4.0-green.svg)](https://github.com/vkhatri/chef-filebeat) [![Build Status](https://travis-ci.org/vkhatri/chef-filebeat.svg?branch=master)](https://travis-ci.org/vkhatri/chef-filebeat)
...
```ruby
cookbook 'filebeat', '~> 0.4.0'
```

## From Git

```ruby
cookbook 'filebeat', github: 'vkhatri/chef-filebeat',  tag: 'v0.4.0'
```
